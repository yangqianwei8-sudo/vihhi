...
class AccountSubjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('其他信息', {
            'fields': ('description', 'is_active', 'created_by', 'created_time')
        }),
    )
...
class BudgetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('其他信息', {
            'fields': ('description', 'created_by', 'created_time')
        }),
    )
...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('其他信息', {
            'fields': ('attachment', 'notes', 'created_by', 'created_time')
        }),
    )
...
class FundFlowAdmin(admin.ModelAdmin):
    ...
    def project_link(self, obj):
        if obj.project:
            ...
            return format_html('<a href="{}">{}</a>', url, obj.project.project_number)
        return '-'
