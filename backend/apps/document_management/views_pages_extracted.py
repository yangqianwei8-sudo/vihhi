# ========== INCOMING_DOCUMENT_MENU_STRUCTURE (lines 47-77) ==========
...
# ========== OUTGOING_DOCUMENT_MENU_STRUCTURE (lines 81-177) ==========
        ...
        'children': [
            {
                ...
                'label': '快递公司列表',
                'icon': '📋',
                'url_name': 'document_pages:express_company_list',
                'permission': 'delivery_center.view',
            },
            {
                ...
                'label': '新建快递公司',
                'icon': '➕',
                'url_name': 'document_pages:express_company_create',
                'permission': 'delivery_center.view',
            },
        ]
    },
...
# ========== _get_active_id_from_path (lines 185-230) ==========
...
# ========== _build_incoming_document_sidebar_nav (lines 232-250) ==========
...
# ========== _build_outgoing_document_sidebar_nav (lines 252-270) ==========
...
# ========== _build_delivery_sidebar_nav (lines 272-295) ==========
...
# ========== incoming_document_home (lines 4035-4283) ==========
@login_required
...
# ========== incoming_document_list (lines 4286-4406) ==========
@login_required
...
# ========== incoming_document_create (lines 4409-4504) ==========
@login_required
...
# ========== incoming_document_detail (lines 4507-4528) ==========
@login_required
...
# ========== incoming_document_edit (lines 4531-4611) ==========
@login_required
...
# ========== outgoing_document_home (lines 4616-4865) ==========
@login_required
...
# ========== outgoing_document_list (lines 4868-4989) ==========
@login_required
...
# ========== outgoing_document_create (lines 4992-5152) ==========
@login_required
...
# ========== outgoing_document_detail (lines 5155-5176) ==========
@login_required
...
# ========== outgoing_document_edit (lines 5179-5336) ==========
@login_required
...
# ========== FILE_CATEGORY_STAGES (lines 5582-5590) ==========
...
# ========== file_category_manage (lines 5592-5716) ==========
@login_required
...
# ========== file_category_list (lines 5719-5781) ==========
@login_required
...
# ========== file_category_create (lines 5784-5841) ==========
@login_required
...
# ========== file_template_manage (lines 5846-5993) ==========
@login_required
