...
结算管理服务
提供结算相关的服务功能
产值计算相关服务已迁移到output_value_management
"""
...
# 结算管理仍需要调用产值管理的服务函数
from backend.apps.output_value_management import services as output_value_services

# 为向后兼容，提供get_project_output_value_for_settlement的别名
get_project_output_value_for_settlement = output_value_services.get_project_output_value_for_settlement
