...
class OutputValueRecord(models.Model):
    """产值计算记录模型"""
    project = models.ForeignKey('project_center.Project', on_delete=models.CASCADE, related_name='output_value_records',
                               verbose_name='关联项目')
...
class ProjectSettlement(models.Model):
    ...
    # 关联信息
    project = models.ForeignKey('project_center.Project', on_delete=models.PROTECT, 
