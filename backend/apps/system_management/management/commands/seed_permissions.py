...
PERMISSION_DEFINITIONS = [
    ...
    # 管理权限：包含创建、编辑、删除、分解等所有管理操作
    {"code": "plan_management.goal.manage", "module": "计划管理", "action": "goal.manage", "name": "计划管理-管理目标", "description": "管理战略目标（创建、编辑、删除、分解等所有管理操作，用于目标制订菜单，自动包含 create、edit、delete、decompose、publish 权限）"},
    {"code": "plan_management.manage_goal", "module": "计划管理", "action": "goal.manage", "name": "计划管理-管理目标", "description": "管理战略目标（创建、编辑、删除、分解等所有管理操作，兼容别名，等同于 goal.manage）"},
    ...
    {"code": "plan_management.goal.publish", "module": "计划管理", "action": "goal.publish", "name": "计划管理-发布目标", "description": "发布目标（制定中→已发布，入口：目标详情页，需 manage_goal 或 goal.publish）"},
    {"code": "plan_management.goal.accept", "module": "计划管理", "action": "goal.accept", "name": "计划管理-接收目标", "description": "接收已发布的公司目标（已发布→已接收，入口：目标详情页；个人目标仅 owner 可接收）"},
    {"code": "plan_management.goal.start_execution", "module": "计划管理", "action": "goal.start_execution", "name": "计划管理-开始执行目标", "description": "将已接收目标开始执行（已接收→执行中，入口：目标详情页）"},
