...
urlpatterns = [
    ...
    path('query/', lambda request: redirect('project_pages:project_list', permanent=False)),
    ...
    # 项目立项路由
    path('initiation/create/', views_initiation.project_initiation_create, name='project_initiation_create'),
    path('initiation/<int:project_id>/step2/', views_initiation.project_initiation_step2, name='project_initiation_step2'),
    path('initiation/<int:project_id>/step3/', views_initiation.project_initiation_step3, name='project_initiation_step3'),
    path('initiation/<int:project_id>/step4/', views_initiation.project_initiation_step4, name='project_initiation_step4'),
    path('initiation/<int:project_id>/submit/', views_initiation.project_initiation_submit, name='project_initiation_submit'),
    path('initiation/list/', views_initiation.project_initiation_list, name='project_initiation_list'),
    path('initiation/<int:project_id>/detail/', views_initiation.project_initiation_detail, name='project_initiation_detail'),
    path('initiation/<int:project_id>/approve/', views_initiation.project_initiation_approve, name='project_initiation_approve'),
    path('initiation/<int:project_id>/receive/', views_initiation.project_initiation_receive, name='project_initiation_receive'),
    path('initiation/<int:project_id>/withdraw/', views_initiation.project_initiation_withdraw, name='project_initiation_withdraw'),
    path('initiation/api/service-professions/', views_initiation.get_service_professions, name='get_service_professions'),
    path('initiation/<int:project_id>/delete/', views_initiation.project_initiation_delete, name='project_initiation_delete'),
]
