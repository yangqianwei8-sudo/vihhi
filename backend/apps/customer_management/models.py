...
class ContactTracking(models.Model):
    ...
    related_opportunity = models.ForeignKey(
        'opportunity_management.BusinessOpportunity',
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
class ContractNegotiation(models.Model):
    ...
    # 关联信息
    contract = models.ForeignKey('contract_management.BusinessContract', on_delete=models.CASCADE, related_name='negotiations', verbose_name='关联合同', null=True, blank=True, help_text='可选，如果洽谈时合同尚未创建可留空')
