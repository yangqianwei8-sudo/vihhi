...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('customer_success', '0004_copy_contracts'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='businesscontract',
            name='client',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='contracts', to='customer_success.client', verbose_name='客户'),
        ),
        migrations.AddField(
            model_name='businesscontract',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='用于补充协议、变更协议关联主合同', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_contracts', to='customer_success.businesscontract', verbose_name='主合同'),
        ),
        migrations.AddField(
            model_name='businesscontract',
        ...
        migrations.AlterField(
            model_name='businesscontract',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contracts', to='project_center.project', verbose_name='关联项目'),
        ),
        migrations.AddIndex(
            model_name='businesscontract',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='customer_success.businesscontract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='contractfile',
            name='uploaded_by',
        ...
        migrations.AddField(
            model_name='contractchange',
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='changes', to='customer_success.businesscontract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='contractchange',
            name='created_by',
        ...
        migrations.AddField(
            model_name='contractapproval',
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='customer_success.businesscontract', verbose_name='合同'),
        ),
    ]
