    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_logs', to='customer_success.businessopportunity', verbose_name='商机')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followups', to='customer_success.businessopportunity', verbose_name='商机')),
            ],
            options={
                'verbose_name': '商机跟进记录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='customer_success.businessopportunity', verbose_name='商机')),
            ],
            options={
                'verbose_name': '商机审批记录',
        ...
        migrations.AddField(
            ...
            name='client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='opportunities', to='customer_success.client', verbose_name='关联客户'),
        ),
        migrations.AddField(
            model_name='businessopportunity',
            name='created_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotations', to='customer_success.businessopportunity', verbose_name='商机')),
                ('quotation_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customer_success.quotationrule', verbose_name='使用的报价规则')),
            ],
            options={
                'verbose_name': '商机报价',
