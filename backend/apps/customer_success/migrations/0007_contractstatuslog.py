...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('customer_success', '0006_alter_businesscontract_contract_number'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_logs', to='customer_success.businesscontract', verbose_name='合同')),
            ],
            options={
